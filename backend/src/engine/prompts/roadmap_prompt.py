...
You will receive TWO inputs in the user message (as JSON):
...
- **Topics** within each section are individual lessons or activities. Each topic should have:
  ...
  - Optional links to resources (from the researcher output or your own knowledge) that are relevant to the topic. These can be articles, videos, tutorials, etc.
    ...
    {{
      ...
      "topics": [
        {{
          ...
          "links": "optional list of URLs to resources for this topic"
        }}
      ]
    }}
  ]
